package com.mstanford.gameframework.utils;
...
public class DrawUtils
{
	...
	public static final int	BORDERX			= (DrawUtils.SCREENW - BORDERW) / 2;
	public static final int	BORDERY			= (DrawUtils.SCREENH - BORDERH) / 2;
