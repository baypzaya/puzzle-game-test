...
public class AboutGameView extends BaseGameView implements GameView {

	public AboutGameView(Context context) {
		super(context);
	}
	...
	public void onDraw(Canvas canvas) {
		if(mScreenWidth>0&&mScreenHeight>0){
			...
			DrawUtils.drawString(canvas, "about", mScreenWidth,mScreenHeight, paint);
		}
