...
import com.gmail.txyjssr.reader.YReaderApplication;
...
public class DBManager {
	...
	public static DBManager getInstance() {
		if (sDBManager == null) {
			sDBManager = new DBManager(YReaderApplication.sContext);
		}
		return sDBManager;
	}
	...
	public int delete(String table, ContentValues values, String whereClause, String[] whereArgs) {
