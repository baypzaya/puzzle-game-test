 ...
 * management. You create a subclass implementing {@link #onCreate},
 * {@link #onUpgrade} and optionally {@link #onOpen}, and this class takes care
 * of opening the database if it exists, creating it if it does not, and
 * upgrading it as necessary. Transactions are used to make sure the database is
...
public abstract class SDCardSQLiteOpenHelper {
	...
	public synchronized SQLiteDatabase getWritableDatabase() {
		...
		try {
			...
			if (mName == null || !SDCardUtils.isSDCardEnable()) {
...
//数据库存放位置
	public File getDatabasePath(String name) {
		String path = SDCardUtils.GetDBPath();
