...
public class ParserFactory {
	...
	public static final int TYPE_BOOKORDER = 823;
	public static final int TYPE_CHECKBOOKORDER = 824;
	public static final int TYPE_KTOUCHTOKEN = 825;
	...
	public static AbstractParser createParser(int type, String data) {
		...
		case TYPE_BOOKORDER:
			return new BookOderParase(data);
		case TYPE_CHECKBOOKORDER:
			return new CheckBookOrderParase(data);
		case TYPE_KTOUCHTOKEN:
			return new KTouchTokenParase(data);
		default:
			throw new IllegalArgumentException(
