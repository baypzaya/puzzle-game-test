...
public class PageWidget extends View {
	...
	public PointF mTouch = new PointF(); // 拖拽点
	public PointF mBezierStart1 = new PointF(); // 贝塞尔曲线起始点
	...
	private boolean bDrawOnlyCurrentPage = false;
	private boolean bDraw = true;
	
	private boolean bAnimate = false;
	private boolean bHasAnimate = false;
	public  boolean  bReturn = false;

	
	private Handler mHandler;
	
	public PageWidget(Context context,int width,int height,Handler handler) {
		super(context);
		mHandler = handler;
		mWidth = width;
		mHeight = height;
	...
	public void SetFlyFlag(boolean flag)
	{
		FlyFlag = flag;
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if(bDraw )
		{
			...
			mHandler.sendEmptyMessage(BookReadActivity.RefreshTool);
		}
	}
