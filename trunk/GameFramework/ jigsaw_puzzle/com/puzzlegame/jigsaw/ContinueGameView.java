...
public class ContinueGameView extends BaseGameView implements GameView {

	public ContinueGameView(Context context) {
		super(context);
	}
	...
	public void onDraw(Canvas canvas) {
		if (mScreenWidth > 0 && mScreenHeight > 0) {
			...
			DrawUtils.drawString(canvas, "continue", mScreenWidth, mScreenHeight, paint);
		}
