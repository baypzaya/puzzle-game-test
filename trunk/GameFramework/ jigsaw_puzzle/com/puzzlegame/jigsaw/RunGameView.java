...
public class RunGameView extends BaseGameView implements GameView {
	...
	public RunGameView(Context context) {
		super(context);
	}
	...
	private Sprite creatSrpites(int index) {
		spriteWidth = mScreenWidth / col;
		spriteHeight = mScreenHeight / row;
	...
	private void showSuccesAnimal(Canvas canvas) {
		...
		canvas.drawText("成 功", mScreenWidth / 2, mScreenHeight / 2, mPaint);
	}
